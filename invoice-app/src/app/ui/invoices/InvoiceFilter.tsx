...
export default function InvoiceFilter({ statuses }: { statuses: string[] }) {
  ...
  return (
    <div className="relative">
      ...
      {isFilterOpened &&
        (<div data-pending={isPending ? "" : undefined} className="absolute top-11 -left-6 flex flex-col gap-2 w-[192px] h-[128px] bg-text dark:bg-headerBackground shadow-modal rounded-lg px-6 py-6" onMouseEnter={openFilterModal} onMouseLeave={closeFilterModal} onTouchStart={openFilterModal} onTouchEnd={closeFilterModal}>
