...
export default function ButtonAddModalWindow() {
  ...
  return (
    <button className="items-center bg-primary w-[90px] md:w-[150px] h-[44px] md:h-[48px] font-bold text-base text-text rounded-3xl hidden md:flex" onClick={() => setFormModal(true)}>
